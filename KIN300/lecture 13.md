...
some defns:
- *strength:* maximal ability to generate force regardless of speed
- *hypertrophy:* increase in size of muscle fibers
- *absolute endurance:* total work which can be completed with same absolute load
- *relative endurance:* total work that can be completed with same relative load
